...
// const fetchAuthData = async (axiosPrivate, setIsLoading, setData) => {
//     let isMounted = true;
//     setIsLoading(true)
...
// const GetAuthedUser = async (axiosPrivate, setAuth, setIsLoading) => {
//     let isMounted = true;
//     try {
...
// const getAnonUser = async (username, setAnonUser, setIsLoading) => {
//     let isMounted = true;
...
// const fetchAnonData = async (username, setData, setIsLoading) => {
//     let isMounted = true;
//     try {
...
// export const PullData = async (auth, axiosPrivate, setIsLoading, setData, setAuth, setAnonUser, username) => {
//     if (auth?.accessToken && hasLocalStorage()) {
//         console.log("has auth")
//         fetchAuthData(axiosPrivate, setIsLoading, setData)
...
//         const authSuccess = await GetAuthedUser(setAuth, setIsLoading);
//         if (authSuccess) {
...
//                 getAnonUser(username, setAnonUser, setIsLoading);
//                 fetchAnonData(username, setData, setIsLoading)
//             }
//         }
//     }
// }
